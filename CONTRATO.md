...
>
> Las HUs 04, 05 y 06 se entregan como esqueletos standalone. Al integrar en `tpFinal.asm`, se borra su `__CONFIG` y su `CBLOCK` y se conserva solo el del archivo final (ver cabecera de `tpFinal.asm`).
